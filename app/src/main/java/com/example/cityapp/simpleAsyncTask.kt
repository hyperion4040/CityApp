...
class simpleAsyncTask(val imageView: WeakReference<ImageView>, val y1: Number, val x1: Number, val y2: Number, val x2: Number) : AsyncTask<Any?, Void?, Any?>() {
    ...
    override fun onPostExecute(result: Any?) {
        ...
        imageView.get()?.setImageBitmap(Bitmap.createScaledBitmap(bmp,150,150,true))
    }
